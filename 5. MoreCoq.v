...
Lemma snoc_rev : forall (l :list nat) (n : nat),
...
Lemma rev_rev : forall (l : list nat),
  l = rev (rev l).
Proof.
...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof.
  intros. rewrite -> H. apply rev_rev.
...
Proof.
  intros n. induction n as [| n'].
    ...
    inversion H1. apply IHn' in H2. inversion H2. reflexivity.
Qed.
