...
(* Answer: Both are used to perform case analysis on an 
   element of an inductively defined type; 
   induction also generates an induction hypothesis,
   while destruct does not.*)
...
Proof.
  ...
  rewrite -> H. rewrite <- IHn'. simpl. reflexivity.
Qed. 
(** [] *)
